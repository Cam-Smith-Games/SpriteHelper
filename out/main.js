...
img.onload = function () {
    ...
    const width = document.querySelector(`#controls div[data-prop='image'] input[data-field='width']`);
    const height = document.querySelector(`#controls div[data-prop='image'] input[data-field='height']`);
...
function syncInputs() {
    for (let prop in settings) {
        ...
        let p = settings[prop];
        for (let field in p) {
            const input = document.querySelector(`#controls div[data-prop='${prop}'] input[data-field='${field}']`);
            input.value = p[field];
        }
    }
}
const inputs = document.querySelectorAll("#controls input:not(readonly):not([type='file'])");
